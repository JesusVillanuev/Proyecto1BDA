...
public class Retiro {
     ...
     */
    public Retiro(int folio, int contraseña, String fechaHoraLimite, String estado) {
        this.folio = folio;
     ...
     * @param estado estado del retiro
     */
    public Retiro(int idOperacion, int folio, int contraseña, String fechaHoraLimite, String estado) {
