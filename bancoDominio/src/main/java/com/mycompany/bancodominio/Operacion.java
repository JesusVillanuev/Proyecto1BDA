...
public class Operacion {
     ...
     */
    public Operacion(String tipo, String fechaHora, float monto, int idCuenta) {
        this.tipo = tipo;
     ...
     * @param idCuenta id de la cuenta que se realiza la operacion
     */
    public Operacion(int idOperacion, String tipo, String fechaHora, float monto, int idCuenta) {
