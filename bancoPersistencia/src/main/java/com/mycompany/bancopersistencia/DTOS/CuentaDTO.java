...
public class CuentaDTO {
     ...
     */
    public CuentaDTO(int numeroCuenta, String estado, String fechaApertura, float saldo, int idCliente) {
     ...
     * @param idCliente id del cliente que le pertenece la cuenta
     */
    public CuentaDTO(int idCuenta, int numeroCuenta, String estado, String fechaApertura, float saldo, int idCliente) {
