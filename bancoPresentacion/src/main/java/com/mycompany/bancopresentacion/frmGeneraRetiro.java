 ...
 * @author JESUS
 */
public class frmGeneraRetiro extends javax.swing.JFrame {

    /**
     * Creates new form frmGeneraRetiro
     */
    public frmGeneraRetiro() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmGeneraRetiro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmGeneraRetiro().setVisible(true);
            }
        });
    }
